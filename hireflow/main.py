...
"""HireFlow - Main entry point and agent orchestration."""
...
from hireflow.models import init_db, get_session, Job, JobStatus, Application
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="HireFlow - Agentic AI Job Application System")
