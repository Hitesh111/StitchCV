...
from stichcv.services.browser_service import browser_service
...
def extract_text_from_pdf(file_bytes: bytes) -> str:
    ...
    try:
        ...
        if not extracted:
            raise ValueError(
                "No extractable text was found in this PDF, even after OCR. If this is a StichCV-generated PDF, use the JSON export instead."
            )
        return extracted
...
async def extract_job_description_from_url(url: str) -> str:
    ...
    if "linkedin.com" in hostname:
        ...
        from stichcv.scrapers.linkedin_scraper import LinkedInScraper
